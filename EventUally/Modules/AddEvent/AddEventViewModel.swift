...
final class AddEventViewModel {
    ...
    init(cellBuilder: AddEventCellBuilder, eventService: EventServiceProtocol = EventService()) {
    ...
    func didTapDoneButton() {
        ...
        eventService.perform(.add, input: .init(name: name, date: rawDate, image: image))
